...
public class WeekOneChallenges : MonoBehaviour
{
    ...
    //used as placeholders to select the correct text when debuged
    public string watchClause;
    public string rumourClause;

    void Start()
    {
        //grabs the sum of the age and favorite number
        ...
        //the full statement debug (shortened because it's too long)
        Debug.Log("Greetings, my name is " + myName + ", my age in years is " + age + ", that means my date of birth is " + birthDay + " " + birthMonth + 
            " " + birthYear + ", I am " + height + "cm tall and in case you are wondering, the rumours are " + rumourClause + " I " + watchClause + 
